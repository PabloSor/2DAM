import 'package:chomon_app/screens/daw_screen.dart';
import 'package:chomon_app/screens/lm_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          'daw': (BuildContext context) => DawScreen(),
          'lm': (BuildContext context) => LmScreen(),
        });
  }
}
